...
Standalone Godot editor plugin for scattering cliff meshes, rock formations, plants, or other scene meshes onto arbitrary surfaces.

## What It Does
- Places instances onto a target surface using downward ray tests
- Can align instances to hit normals
...
2. Assign one or more source scenes.
3. Configure spacing, density, rotation, scale, and offset.
4. Generate the layout.
5. Clear and regenerate as needed.

## Intended Use
This plugin is meant for fast environment dressing and iteration, especially for cliffs, rock formations, plant clusters, and other repeated placements where hand placement is too slow.
